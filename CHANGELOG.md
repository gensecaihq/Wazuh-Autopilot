...
- **README overhaul**: redesigned, professionally decorated header (tech + runtime badges, highlights strip, "Why Star This Project"), corrected stale counts (**578 tests** / ~6800 LOC — previously 548/6400), and a complete, categorized documentation index (all 18 docs, several were previously unlisted).
